...
define(function(require) { return function(n) {
	var pageIndex = 0;
    var vqd = require('./royalslider.page.js');
    ...
    u.prototype = {
        ...
        _g2: function(b, f) {
            ...
            if (c._l2) e && (c._v2 = !0);
                ...
                function(a) {
                    c._x2(a, f)
                }).on(c._l1,{component:this},function(a) {
					//触发touchend
					var startY,endY,plen = $(".container").length;
					startY = a.data.component._d3;
					endY = a.data.component._c3;
					if(startY > endY){
						//向上滑
						console.log("up");
						if(pageIndex < plen){
        ...
        _p3: function(b) {
			...
			/*
			if(axx == 0){
				//$("body").attr("data-top",(-b +$(window).height()));
				axx = 1;
				acc ++;
				//console.log(this._h ? b + this._z1 + 0 : 0 + this._z1 + b);
				setTimeout(function(){
					axx = 0;
				},500);
			}
